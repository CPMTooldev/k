...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if all(key in data for key in ['floats', 'localID', 'money', 'coin']):
            ...
            print(Colorate.Horizontal(Colors.rainbow, f'Total Friends: {friends_count}.'))
            ...
            print(Colorate.Horizontal(Colors.rainbow, f'Total Cars: {car_count}.'))
...
def load_client_details():
    ...
    data = response.json()
    console.print("[bold][red]========[/red][ 𝙇𝙊𝘾𝘼𝙏𝙄𝙊𝙉 ][red]========[/red][/bold]")
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if cpm.unlock_paid_cars():
                    ...
                    sleep(2)
                    continue
            elif service == 35: # Unlock toyota crownd
                console.print("[!] Note: this function takes a while to complete, please don't cancel.", end=None)
