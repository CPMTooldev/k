...
class CPMTooldev:
    ...
    def change_password(self, new_password):
        ...
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/change_password", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def get_player_car(self, car_id) -> any:
        ...
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/get_car", params=params, json=payload)  # Changed
        response_decoded = response.json()
        return response_decoded.get("ok")
    ...
    def delete_player_friends(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/delete_friends", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_w16(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_w16", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_horns(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_horns", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def disable_engine_damage(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/disable_damage", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlimited_fuel(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlimited_fuel", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def levels(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/levels", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def set_player_wins(self, amount) -> bool:
        payload = { "account_auth": self.auth_token, "amount": amount }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/set_race_wins", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def set_player_loses(self, amount) -> bool:
        payload = { "account_auth": self.auth_token, "amount": amount }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/set_race_loses", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_houses(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_houses", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_smoke(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_smoke", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_all_lamborghinis(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_all_lamborghinis", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_all_cars(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_all_cars", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_all_carss(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_all_carss", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_car_by_id(self, car_id: int) -> bool:
        payload = { "account_auth": self.auth_token, "car_id": car_id }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_car_by_id", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_car_by_ids(self, car_id: int) -> bool:
        payload = { "account_auth": self.auth_token, "car_id": car_id }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_car_by_ids", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_all_cars_siren(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_all_cars_siren", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def account_clone(self, account_email, account_password) -> bool:
        ...
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/clone", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def set_player_plates(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/set_plates", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_wheels(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_wheels", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_equipments_male(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_equipments_male", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_hat_m(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_hat_m", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def rmhm(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/rmhm", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_topm(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_topm", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_topmz(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_topmz", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_topmx(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_topmx", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_equipments_female(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_equipments_female", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def rmhfm(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/rmhfm", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_topf(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_topf", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_topfz(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_topfz", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def hack_car_speed(self, car_id, new_hp, new_inner_hp, new_nm, new_torque):
        ...
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/hack_car_speed", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def hack_cars_speed(self, new_hp, new_inner_hp, new_nm, new_torque):
        ...
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/hack_cars_speed", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_animations(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_animations", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def max_max1(self, car_id, custom):
        ...
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/max_max1", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def max_max2(self, car_id, custom):
        payload = { "account_auth": self.auth_token, "car_id": car_id, "custom": custom }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/max_max2", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def millage_car(self, car_id, custom):
        payload = { "account_auth": self.auth_token, "car_id": car_id, "custom": custom }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/millage_car", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def brake_car(self, car_id, custom):
        payload = { "account_auth": self.auth_token, "car_id": car_id, "custom": custom }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/brake_car", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def headlight(self, car_id):
        payload = { "account_auth": self.auth_token, "car_id": car_id }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/headlight", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_crown(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_crown", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def unlock_cls(self) -> bool:
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/unlock_cls", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def rear_bumper(self, car_id):
        payload = { "account_auth": self.auth_token, "car_id": car_id }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/rear_bumper", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def front_bumper(self, car_id):
        payload = { "account_auth": self.auth_token, "car_id": car_id }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/front_bumper", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def telmunnongodz(self, car_id, custom):
        payload = { "account_auth": self.auth_token, "car_id": car_id, "custom": custom }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/telmunnongodz", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def telmunnongonz(self, car_id, custom):
        payload = { "account_auth": self.auth_token, "car_id": car_id, "custom": custom }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/telmunnongonz", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def incline(self, car_id, custom):
        payload = { "account_auth": self.auth_token, "car_id": car_id, "custom": custom }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/incline", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def copy_livery(self, source_car_id, target_car_id):
        ...
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/copy_livery", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def clone_car_to(self, source_car_id, target_email, target_password):
        ...
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/clone_car_to", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def copy_car_to(self, source_car_id, target_email, target_password, target_car_id):
        payload = { "account_auth": self.auth_token, "source_car_id": source_car_id, "target_email": target_email, "target_password": target_password, "target_car_id": target_car_id }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/copy_car_to", params=params, json=payload)  # Changed
        response_decoded = response.json()
    ...
    def shittin(self):
        payload = { "account_auth": self.auth_token }
        params = { "key": self.access_key }
        response = requests.post(f"{__ENDPOINT_URL__}/shittin", params=params, json=payload)  # Changed
        response_decoded = response.json()
